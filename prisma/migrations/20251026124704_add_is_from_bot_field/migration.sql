...
INSERT INTO "new_Message" ("content", "createdAt", "enrichmentStatus", "id", "messageType", "metadata", "senderSsid", "threadId", "timestamp") SELECT "content", "createdAt", "enrichmentStatus", "id", "messageType", "metadata", "senderSsid", "threadId", "timestamp" FROM "Message";
DROP TABLE "Message";
